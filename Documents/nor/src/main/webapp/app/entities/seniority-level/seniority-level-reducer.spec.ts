...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENIORITYLEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SENIORITYLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SENIORITYLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SENIORITYLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SENIORITYLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SENIORITYLEVEL actions', async () => {
      const expectedActions = [
        {
